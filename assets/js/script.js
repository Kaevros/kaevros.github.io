// /assets/js/script.js - ANİMASYON MANTIĞI DÜZELTİLDİ, ARAMA MOTORU YENİLENDİ
...
function setupSearch() {
    ...
    function openSearch() { initializeSearch(); searchModal.classList.add('active'); searchModalInput.focus(); }
    function closeSearch() { searchModal.classList.remove('active'); searchInput.value = ''; searchModalInput.value = ''; resultsList.innerHTML = ''; }
    
    searchInput.addEventListener('focus', (e) => { e.preventDefault(); openSearch(); });
    ...
    searchModalInput.addEventListener('input', (e) => {
        ...
        if (query.length < 2 || !idx) { resultsList.innerHTML = ''; return; }
    ...
    function displayResults(results) {
        ...
        if (results.length > 0) {
            ...
            resultsHTML = '<li class="no-results">Sonuç bulunamadı.</li>';
        }
