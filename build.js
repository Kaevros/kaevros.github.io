// build.js - TÜM İSTEKLERİ KARŞILAYAN NİHAİ VERSİYON
...
const siteBaseUrl = 'https://kaevros.github.io'; // RSS ve meta etiketler için site URL'si
...
async function buildSite() {
    ...
    if (await fs.pathExists(staticPagesDir)) {
        ...
        console.log(`--- ${await (await fs.readdir(staticPagesDir)).length} adet statik sayfa oluşturuldu.`);
    }
